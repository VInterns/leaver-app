...
const resignationsDetailsRouterFactory = require('./routes/resignations-details');
...
const appFactory = (db, sessionStoreProvider) => {
    ...
    app.use(`${API_ROOT_PATH}/resignations-details`, resignationsDetailsRouterFactory(db));
