...
const resignationsInternalRouterFactory = require('./routes/resignations-internal');
...
const appFactory = (db, sessionStoreProvider) => {
    ...
    app.use(`${API_ROOT_PATH}/resignations-internal`, resignationsInternalRouterFactory(db));
