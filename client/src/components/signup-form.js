...
// FIXME: this view is rendered when this.props.codeRequested === true, but it is not rendering when the value is set
        ...
        return(
            <Grid divided style = {{ margin: 5, fontFamily: 'Poppins'}}>
                ...
                >
                {(this.props.codeRequested === true)? (renderCodeSentView): (renderGetCodeView)}
                </Grid.Column>
                {loading}
            </Grid>
        )
